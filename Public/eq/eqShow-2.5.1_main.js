            ...
            function(a, c, d, e, f, g) {
                ...
                function B(a) {
                    d.open({
                        ...
                        b && "http://" != b ? (a.properties.url = isNaN(b) ? PREFIX_S1_URL + "index-jumpgo=" + a.sceneId + "&url=" + encodeURIComponent(b) : b, $("#inside_" + a.id).find(".fa-link").removeClass("fa-link").addClass("fa-anchor")) : (delete a.properties.url, $("#inside_" + a.id).find(".fa-anchor").removeClass("fa-anchor").addClass("fa-link"))
                    })
                }
                var C = {},
