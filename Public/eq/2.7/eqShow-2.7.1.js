...
function(a, b, c) {
	...
	b.module("app", ["ngRoute", "home", "sample", "main", "reg", "scene", "my", "data", "data.edit", "error", "usercenter", "ui.bootstrap", "ui.grid", "ui.grid.selection", "ngSanitize", "ui.select", "services.i18nNotifications", "services.httpRequestTracker", "services.sample", "services.config", "security", "app.upload", "templates-app", "templates-common", "ui.sortable", "I18N.MESSAGES", "app.directives.notification"]), b.module("app").config(["$routeProvider", "$locationProvider", "securityAuthorizationProvider", "uiSelectConfig", function(a, b, c, d) {
		...
		return {
			...
			link: function(b, c) {
				...
				a.getBanners().then(function(a) {
					d.append('<img src="assets/images/slide2_03.png" width="1000px" height="720px" alt="Slide 1">');
					$(c).slides({
						preload: !0,
						play: 5e3,
						pause: 2500,
		...
		a.put("footer.tpl.html", '<footer>\n	<div class="content_center">\n		<article class="footer">\n			<p class="beizhu">(c) 2015 <a href="http://www.48ym.com">www.48ym.com</a>. All rights reserved   粤ICP备888888</p>\n        	<p>\n				<a  target="_blank" rel="nofollow" style="margin: 0 auto;">\n					<img ng-src="{{CLIENT_CDN}}assets/images/sn.png">\n				</a>\n        		<a target="_blank" href="http://www.48ym.com">加入我们</a>|<a href="http://www.48ym.com" target="_blank" >意见反馈</a>|<a target="_blank" href="http://www.48ym.com">内容举报</a>|<a target="_blank" href="http://www.48ym.com">关于我们</a>|<a target="_blank" href="http://www.48ym.com">论坛</a>|<a target="_blank" href="http://www.48ym.com">帮助中心</a>\n        	</p>\n        </article>\n	</div>\n</footer>')
