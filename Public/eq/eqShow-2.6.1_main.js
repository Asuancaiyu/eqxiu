            ...
            function(a, c, d, e, f, g, h) {
                ...
                function D(a) {
                    d.open({
                        ...
                        b && "http://" != b ? (isNaN(b) ? a.properties.url = PREFIX_S1_URL + "index-jumpgo=" + a.sceneId + "&url=" + encodeURIComponent(b) : (a.properties.url = b, console.log(b)), $("#inside_" + a.id).find(".fa-link").removeClass("fa-link").addClass("fa-anchor")) : (delete a.properties.url, $("#inside_" + a.id).find(".fa-anchor").removeClass("fa-anchor").addClass("fa-link"))
                    })
                } {
                    var E = {},
