...
! function($) {
    ...
    function parseJson(a) {
        ...
        customLastPage = !1, appendLastPage(a, b), bindShare(a), document.title = a.obj.name, $("#metaDescription").attr("content", a.obj.name + ", " + a.obj.description + ", 由App吾爱免费移动场景应用自营销管家提供技术支持"), $(".scene_title").html(a.obj.name);
