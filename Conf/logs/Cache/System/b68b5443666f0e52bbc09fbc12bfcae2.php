...
<div id="artlist">
	<div class="mod kjnav">
		...
		<?php if(($action == 'Article') or ($action == 'Img') or ($action == 'Text') or ($action == 'Voiceresponse')): break; endif; endforeach; endif; else: echo "" ;endif; ?>
						...
						<form action="<?php echo U('Baseset/edit');?>" method="post" name="form" id="myform">
			            <table class="table table-striped table-bordered" style="margin-top:10px;" id="set_table">
						 

						 <tr>
							
							<td width="150">用户默认可使用场景个数</td>
							
							<td colspan="3" class="lt">
								<input type="text" name="scene_times" class="ipt" size="45" value="<?php echo ($data["scene_times"]); ?>">
							</td>
							...
							<tr>
								<td width="150">用户默认可使用场景天数</td>
									
							
							<td colspan="3" class="lt">
								<input type="text" name="free_time" class="ipt" size="45" value="<?php echo ($data["free_time"]); ?>">
							</td>
							</tr>
